...
const notFoundSeo: SeoPageDefinition = {
  ...
  title: 'Page introuvable | KRAAK Consulting',
  description:
    "La page demand̩e est introuvable. Retrouvez la FAQ, l'accueil ou le formulaire de contact KRAAK.",
  openGraph: {
    title: 'Page introuvable | KRAAK Consulting',
    description:
      "La page demand̩e est introuvable. Retrouvez la FAQ, l'accueil ou le formulaire de contact KRAAK.",
...
export const routes: Routes = buildRoutes();
>>>>>>> a57fdaa (fix(web): strip preview and participant artifacts from prod bundle)
