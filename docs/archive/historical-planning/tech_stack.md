...
> Active reference: [OVERVIEW](../../architecture/OVERVIEW.md)
...
- [Stack Technologique Du MVP KRAAK](#stack-technologique-du-mvp-kraak)
  - [1. Décision globale](#1-decision-globale)
  - [2. Choix finaux](#2-choix-finaux)
    - [Type de site](#type-de-site)
      - [Choix : site web marketing personnalisé](#choix-site-web-marketing-personnalise)
      - [Pourquoi](#pourquoi)
  - [3. Stack technique retenue](#3-stack-technique-retenue)
    - [Runtime / outillage](#runtime-outillage)
    - [Front-end](#front-end)
    - [Back-end / services](#back-end-services)
    - [Analyse / SEO](#analyse-seo)
    - [Gestion de contenu](#gestion-de-contenu)
  - [4. Pourquoi ces choix](#4-pourquoi-ces-choix)
    - [Angular + prerender au lieu d’une SPA pure](#angular-prerender-au-lieu-dune-spa-pure)
      - [Avantages du prerender Angular](#avantages-du-prerender-angular)
    - [PrimeNG 21 + Tailwind](#primeng-21-tailwind)
      - [Avantages de PrimeNG 21 + Tailwind](#avantages-de-primeng-21-tailwind)
    - [Signals + services + RxJS pour la gestion d’état](#signals-services-rxjs-pour-la-gestion-detat)
      - [Choix final : Angular Signals + services + RxJS](#choix-final-angular-signals-services-rxjs)
      - [Pourquoi retenir Signals + services + RxJS](#pourquoi-retenir-signals-services-rxjs)
    - [NestJS + Supabase](#nestjs-supabase)
      - [Pourquoi associer NestJS et Supabase](#pourquoi-associer-nestjs-et-supabase)
    - [Formulaires : API personnalisée au lieu de Formspree / Tally / Google Forms](#formulaires-api-personnalisee-au-lieu-de-formspree-tally-google-forms)
      - [Choix final : API NestJS + Resend + Supabase](#choix-final-api-nestjs-resend-supabase)
      - [Pourquoi une API personnalisée pour les formulaires](#pourquoi-une-api-personnalisee-pour-les-formulaires)
  - [5. Hébergement retenu](#5-hebergement-retenu)
    - [Front-end — préproduction](#front-end-preproduction)
      - [Choix : Render](#choix-render)
      - [Rôle de Render](#role-de-render)
    - [Back-end — préproduction](#back-end-preproduction)
      - [Choix : Render via render.yaml](#choix-render-via-renderyaml)
      - [Rôle de Render](#role-de-render-1)
    - [Services managés](#services-manages)
  - [6. Processus de déploiement recommandé](#6-processus-de-deploiement-recommande)
    - [État actuel du repo](#etat-actuel-du-repo)
  - [Structure du dépôt](#structure-du-depot)
  - [Pipeline CI/CD](#pipeline-cicd)
    - [À chaque Pull Request](#a-chaque-pull-request)
    - [À chaque push sur la branche de préproduction](#a-chaque-push-sur-la-branche-de-preproduction)
    - [Docker](#docker)
      - [Choix : oui, Docker dans le pipeline CI/CD](#choix-oui-docker-dans-le-pipeline-cicd)
      - [Usage recommandé](#usage-recommande)
      - [Remarque](#remarque)
  - [7. Fichiers de configuration à prévoir](#7-fichiers-de-configuration-a-prevoir)
    - [Racine](#racine)
    - [Front](#front)
    - [Back](#back)
    - [CI/CD](#cicd)
  - [8. Variables d’environnement recommandées](#8-variables-denvironnement-recommandees)
    - [Variables client (apps/client/.env / .env.staging)](#variables-client-appsclientenv-envstaging)
    - [Variables back-end (apps/api/.env / .env.staging)](#variables-back-end-appsapienv-envstaging)
    - [Variables Supabase (supabase/.env.staging)](#variables-supabase-supabaseenvstaging)
    - [Variables optionnelles mais utiles](#variables-optionnelles-mais-utiles)
  - [9. Décision finale recommandée](#9-decision-finale-recommandee)
  - [10. Résumé en une phrase](#10-resume-en-une-phrase)
