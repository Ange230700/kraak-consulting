...
> Active reference: [README](../../generated/README.md)
...
- `docs/generated/primeng/llms-full.md` : environ 2,7 Mo, documentation PrimeNG générée.
...
- Décider si `docs/generated/primeng/llms-full.md` doit être généré localement au lieu d'être commité.
