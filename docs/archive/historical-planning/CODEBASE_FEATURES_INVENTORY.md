...
- [KRAAK Codebase Feature Inventory (May 9, 2026)](#kraak-codebase-feature-inventory-may-9-2026)
  - [Executive Summary](#executive-summary)
    - [Key Finding](#key-finding)
  - [Part 1: Web Pages](#part-1-web-pages)
    - [Marketing Vitrine (MVP - Public, No Auth)](#marketing-vitrine-mvp-public-no-auth)
    - [Participant Area (V1.1 Feature, NOT MVP)](#participant-area-v11-feature-not-mvp)
  - [Part 2: Mobile Pages (All Participant Area)](#part-2-mobile-pages-all-participant-area)
    - [Mobile Routes (All Authenticated)](#mobile-routes-all-authenticated)
  - [Part 3: API Endpoints](#part-3-api-endpoints)
    - [Public Endpoints (No Auth Required)](#public-endpoints-no-auth-required)
    - [Authenticated Endpoints (Bearer Token Required)](#authenticated-endpoints-bearer-token-required)
      - [Dashboard & Overview](#dashboard-overview)
      - [Programs](#programs)
      - [Announcements](#announcements)
      - [Support (Tracking)](#support-tracking)
      - [Profile](#profile)
  - [Part 4: Feature Flags](#part-4-feature-flags)
    - [enableParticipantArea](#enableparticipantarea)
      - [Configuration by Environment](#configuration-by-environment)
      - [Behavior](#behavior)
      - [Implementation Details](#implementation-details)
      - [Temporary Status](#temporary-status)
  - [Part 5: Runtime Configuration](#part-5-runtime-configuration)
    - [Config Object Structure](#config-object-structure)
    - [Loading Mechanism](#loading-mechanism)
    - [Environment Files](#environment-files)
  - [Part 6: V1.1 Features (Planned, Not Implemented)](#part-6-v11-features-planned-not-implemented)
    - [Payment (M8)](#payment-m8)
    - [Learning Management System (M9)](#learning-management-system-m9)
    - [Participant Documents (M9)](#participant-documents-m9)
    - [CMS Admin (M9)](#cms-admin-m9)
    - [CRM & Marketing (M10)](#crm-marketing-m10)
    - [Advanced Push Notifications](#advanced-push-notifications)
  - [Part 7: Code Patterns & Observations](#part-7-code-patterns-observations)
    - [Data Modeling](#data-modeling)
    - [Authentication & Access Control](#authentication-access-control)
    - [Partially Realized Features](#partially-realized-features)
  - [Part 8: Testing Coverage](#part-8-testing-coverage)
    - [Test Results (QAT-05 - Full Regression)](#test-results-qat-05-full-regression)
    - [E2E Coverage (QAT-04 - Participant Flows)](#e2e-coverage-qat-04-participant-flows)
  - [Part 9: Decision Documents](#part-9-decision-documents)
  - [Part 10: Cleanup & Migration Path](#part-10-cleanup-migration-path)
    - [Post-MVP Actions (When Participant Area Goes Live)](#post-mvp-actions-when-participant-area-goes-live)
