...
| [STAGING_PROMOTION.md](docs/operations/STAGING_VALIDATION.md)          | Staging deployment details            |
| [RELEASE_PROD.md](docs/operations/RELEASE_PROD.md)                     | Production release procedure          |
