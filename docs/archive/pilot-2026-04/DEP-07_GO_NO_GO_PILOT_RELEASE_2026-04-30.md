...
> Active reference: [RELEASE_PROD](../../operations/RELEASE_PROD.md)
...
- runbook de distribution interne livré : `docs/archive/pilot-2026-04/DEP-04_MOBILE_TEST_DISTRIBUTION_2026-04-30.md`
...
- iOS : procédure TestFlight documentée dans `docs/archive/pilot-2026-04/DEP-04_MOBILE_TEST_DISTRIBUTION_2026-04-30.md`
...
| Document                                                                      | Rôle                                    |
| ----------------------------------------------------------------------------- | --------------------------------------- |
| `docs/archive/pilot-2026-04/DEP-04_MOBILE_TEST_DISTRIBUTION_2026-04-30.md`    | Distribution APK + TestFlight           |
| `docs/operations/OBSERVABILITY.md`                                            | Observabilité et alerting               |
| `docs/operations/INCIDENT_ROLLBACK.md`                                        | Incident, rollback, checklist pilot     |
| `docs/runbooks/evidence/DEP-07_go-no-go-pilot-release-evidence_2026-04-30.md` | Evidence de validation DEP-07           |
| `docs/operations/ENVIRONMENTS.md`                                             | Variables d'environnement et URLs pilot |
