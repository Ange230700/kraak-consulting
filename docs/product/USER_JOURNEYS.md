...
- [Parcours Utilisateur De L'Application](#parcours-utilisateur-de-lapplication)
  - [Objectif](#objectif)
  - [1. Principes De Cadrage](#1-principes-de-cadrage)
  - [2. Flux MVP À Couvrir](#2-flux-mvp-a-couvrir)
  - [3. Navigation De Premier Lancement](#3-navigation-de-premier-lancement)
    - [Décision retenue](#decision-retenue)
    - [Raisons de ce choix](#raisons-de-ce-choix)
    - [Règle de gel](#regle-de-gel)
  - [4. Structure De Navigation Mobile Gelée](#4-structure-de-navigation-mobile-gelee)
    - [Avant authentification](#avant-authentification)
    - [Après authentification](#apres-authentification)
    - [Détails en navigation empilée](#details-en-navigation-empilee)
    - [Actions transverses](#actions-transverses)
    - [Carte de navigation complète](#carte-de-navigation-complete)
  - [5. Parcours Détaillés Et Critères D'Acceptation](#5-parcours-detailles-et-criteres-dacceptation)
  - [5.1 Sign in](#51-sign-in)
    - [But - Sign in](#but-sign-in)
    - [Déclencheur - Sign in](#declencheur-sign-in)
    - [Parcours nominal - Sign in](#parcours-nominal-sign-in)
    - [Critères d'acceptation - Sign in](#criteres-dacceptation-sign-in)
  - [5.2 First Access / Onboarding](#52-first-access-onboarding)
    - [But - First Access / Onboarding](#but-first-access-onboarding)
    - [Déclencheur - First Access / Onboarding](#declencheur-first-access-onboarding)
    - [Parcours nominal - First Access / Onboarding](#parcours-nominal-first-access-onboarding)
    - [Critères d'acceptation - First Access / Onboarding](#criteres-dacceptation-first-access-onboarding)
  - [5.3 View Dashboard](#53-view-dashboard)
    - [But - View Dashboard](#but-view-dashboard)
    - [Déclencheur - View Dashboard](#declencheur-view-dashboard)
    - [Parcours nominal - View Dashboard](#parcours-nominal-view-dashboard)
    - [Critères d'acceptation - View Dashboard](#criteres-dacceptation-view-dashboard)
  - [5.4 Open Program](#54-open-program)
    - [But - Open Program](#but-open-program)
    - [Déclencheur - Open Program](#declencheur-open-program)
    - [Parcours nominal - Open Program](#parcours-nominal-open-program)
    - [Critères d'acceptation - Open Program](#criteres-dacceptation-open-program)
  - [5.5 View Session Details](#55-view-session-details)
    - [But - View Session Details](#but-view-session-details)
    - [Déclencheur - View Session Details](#declencheur-view-session-details)
    - [Parcours nominal - View Session Details](#parcours-nominal-view-session-details)
    - [Critères d'acceptation - View Session Details](#criteres-dacceptation-view-session-details)
  - [5.6 Open a Resource](#56-open-a-resource)
    - [But - Open a Resource](#but-open-a-resource)
    - [Déclencheur - Open a Resource](#declencheur-open-a-resource)
    - [Parcours nominal - Open a Resource](#parcours-nominal-open-a-resource)
    - [Critères d'acceptation - Open a Resource](#criteres-dacceptation-open-a-resource)
  - [5.7 Read Announcement](#57-read-announcement)
    - [But - Read Announcement](#but-read-announcement)
    - [Déclencheur - Read Announcement](#declencheur-read-announcement)
    - [Parcours nominal - Read Announcement](#parcours-nominal-read-announcement)
    - [Critères d'acceptation - Read Announcement](#criteres-dacceptation-read-announcement)
  - [5.8 Contact Support](#58-contact-support)
    - [But - Contact Support](#but-contact-support)
    - [Déclencheur - Contact Support](#declencheur-contact-support)
    - [Parcours nominal - Contact Support](#parcours-nominal-contact-support)
    - [Critères d'acceptation - Contact Support](#criteres-dacceptation-contact-support)
  - [5.9 Log out](#59-log-out)
    - [But - Log out](#but-log-out)
    - [Déclencheur - Log out](#declencheur-log-out)
    - [Parcours nominal - Log out](#parcours-nominal-log-out)
    - [Critères d'acceptation - Log out](#criteres-dacceptation-log-out)
  - [6. États D'Échec Prioritaires](#6-etats-dechec-prioritaires)
    - [6.1 Bad login](#61-bad-login)
    - [6.2 No enrollment](#62-no-enrollment)
    - [6.3 No internet](#63-no-internet)
    - [6.4 Expired session](#64-expired-session)
    - [6.5 Empty resource list](#65-empty-resource-list)
    - [6.6 Unauthorized access](#66-unauthorized-access)
  - [7. Matrice De Couverture Minimaliste Des Flux](#7-matrice-de-couverture-minimaliste-des-flux)
  - [8. Décision Finale De Navigation MVP](#8-decision-finale-de-navigation-mvp)
    - [Onglets gelés](#onglets-geles)
    - [Écrans de détail gelés](#ecrans-de-detail-geles)
  - [9. Utilisation De Cette Spec](#9-utilisation-de-cette-spec)
