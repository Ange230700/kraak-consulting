...
- issue : `Open -> Closed`
- board : aligner le même jour que le merge vers `staging` ; pour une tâche de
  production, finaliser après la PR de release et le tag SemVer
...
- pilotage thématique dans GitHub Project #6 et ce runbook
