...
CREATE TRIGGER trg_author_updated_at BEFORE
UPDATE ON author FOR EACH ROW EXECUTE PROCEDURE update_updated_at ();

CREATE TRIGGER trg_category_updated_at BEFORE
UPDATE ON category FOR EACH ROW EXECUTE PROCEDURE update_updated_at ();

CREATE TRIGGER trg_tag_updated_at BEFORE
UPDATE ON tag FOR EACH ROW EXECUTE PROCEDURE update_updated_at ();

CREATE TRIGGER trg_article_updated_at BEFORE
UPDATE ON article FOR EACH ROW EXECUTE PROCEDURE update_updated_at ();
